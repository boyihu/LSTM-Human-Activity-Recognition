...
if __name__ == "__main__":
    ...
    DATA_PATH = "data/"
    DATASET_PATH = DATA_PATH + "IMU/"
    print("\n" + "Dataset is now located at: " + DATASET_PATH)
    TRAIN = "train/"
    TEST = "test/"

    X_train_signals_paths = [
        DATASET_PATH + TRAIN + "IMU/" + signal + "train.txt" for signal in INPUT_SIGNAL_TYPES
    ]
    X_test_signals_paths = [
        DATASET_PATH + TEST + "IMU/" + signal + "test.txt" for signal in INPUT_SIGNAL_TYPES
    ]
